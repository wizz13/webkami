...
async function getStats(env) {
    const query = `{
        a: repository(owner: "Wisnu", name: "chino.pages.dev") { stargazers { totalCount } forks { totalCount } }
        b: repository(owner: "Wisnu", name: "debloat-premid") { stargazers { totalCount } forks { totalCount } }
        c: repository(owner: "Wisnu", name: "Wisnu&shofy") { stargazers { totalCount } forks { totalCount } }
        d: repository(owner: "Wisnu", name: "highlight") { stargazers { totalCount } forks { totalCount } }
